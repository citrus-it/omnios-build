...
* OpenSSL updated to version 3.0.18
...
* `openssl` has been updated to version 3.0.17, fixing a low severity CVE.

* `sudo` has been updated to fix CVE-2025-32562.
...
* git updated to version 2.40.4, fixing
